...
<!-- 	<script type="text/javascript" src="resources/js/insframework/insframeworktree.js"></script> -->
	<script type="text/javascript" src="resources/js/wildmachings/weldingMachines.js"></script>
	<script type="text/javascript" src="resources/js/search/search.js"></script>
	<script type="text/javascript" src="resources/js/wildmachings/addweldmaching.js"></script>
	<script type="text/javascript" src="resources/js/wildmachings/removeweldingmachines.js"></script>
  </head>
