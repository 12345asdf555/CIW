	  	...
	  	<div class="easyui-accordion" border="false" id="accordiondiv">
			<div title="生产设备管理" data-options="iconCls:'icon-manager'">
				<ul>
			        ...
			        <li onclick="changeColor(this)"><a href="javascript:opencatMachine()"><div><img src="resources/images/c-12.png" />&nbsp;&nbsp;CAT焊机管理</div></a></li>
			...
			<div title="生产过程管理" data-options="iconCls:'icon-statement'">
				<ul>
			        ...
			        <li onclick="changeColor(this)"><a href="javascript:opencatPerson()" ><div><img src="resources/images/c-6.png" />&nbsp;&nbsp;cat焊工管理</div></a></li>
...
>>>>>>> branch 'Xuzhou' of https://github.com/12345asdf555/CIW.git
	</div>
