...
<html>
  ...
  <body style="background:#24375b;color:#fff">
	...
	<div style="width:96%;float:left;border:2px solid #5d99dd;border-radius: 30px;margin-left:20px;margin-right:20px;">
		<div class="wcchart" style="width:35%"></div>
		<div class="wcchart" >
			<a href="javascript:openLive()"><div style="margin-top:10px;margin-bottom:10px;"><img src="resources/images/live.png" width="28%"></div></a>
			设备焊机状态监控
		</div>
		<div class="wcchart" style="width:35%"></div>
	</div>
